...
def process_labelled_boxes(labelled_boxes, orig_size):
    ...
    for box, label in labelled_boxes.items():
        ...
        data_points += [(label, midpoint)]

    print(data_points)
    print("Mouse position: {}".format(pyautogui.position()))
    if not data_points: return
    print(data_points[0][0][0], data_points[0][1])
    if 'person' in data_points[0][0][0]: pyautogui.click(data_points[0][1])
            ...
            while (True):
                try:
                    ...
                    vis_util.visualize_boxes_and_labels_on_image_array(
                        ...
                        line_thickness=8)
                    process_labelled_boxes(labelled_boxes, img.size)
